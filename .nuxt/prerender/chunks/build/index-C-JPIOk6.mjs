import { mergeProps, computed, unref, useSSRContext } from 'file:///home/lala/Downloads/claude%20caude/recent/portfolio-ismael/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderClass } from 'file:///home/lala/Downloads/claude%20caude/recent/portfolio-ismael/node_modules/vue/server-renderer/index.mjs';
...
import 'file:///home/lala/Downloads/claude%20caude/recent/portfolio-ismael/node_modules/vue-router/vue-router.node.mjs';
import 'file:///home/lala/Downloads/claude%20caude/recent/portfolio-ismael/node_modules/cookie-es/dist/index.mjs';
import 'file:///home/lala/Downloads/claude%20caude/recent/portfolio-ismael/node_modules/vue-devtools-stub/dist/index.mjs';
    ...
    const educations = computed(() => [
      {
        ...
        school: "Universit\xE9 Antananarivo \u2014 Info Centre de la salle"
      },
      {
        year: "18",
        level: t("education.diploma"),
        title: t("education.app_dev"),
        school: "Ath\xE9n\xE9e Saint Joseph Antsirabe"
      },
      {
        year: "15",
        level: t("education.bac"),
        title: t("education.sciences"),
        school: "Lyc\xE9e Arcade Antananarivo"
      },
      {
        year: "\u2014",
        level: "BEPC",
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    const languages = computed(() => [
      { flag: "\u{1F1EB}\u{1F1F7}", name: "Fran\xE7ais", level: t("languages.fr_level"), percent: 95 },
      { flag: "\u{1F1EC}\u{1F1E7}", name: "English", level: t("languages.en_level"), percent: 65 },
      { flag: "\u{1F1EE}\u{1F1F9}", name: "Italiano", level: t("languages.it_level"), percent: 30 },
      { flag: "\u{1F1F2}\u{1F1EC}", name: "Malagasy", level: t("languages.mg_level"), percent: 100 }
    ]);
    return (_ctx, _push, _parent, _attrs) => {
...
//# sourceMappingURL=index-C-JPIOk6.mjs.map
